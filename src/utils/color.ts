...
export const colorByCSSColorSpace = makeValueConfigFn(faker.color.colorByCSSColorSpace);

/** Color [cssSupportedFunction](https://fakerjs.dev/api/color.html#cssSupportedFunction) */
export const cssSupportedFunction = makeValueConfigFn(faker.color.cssSupportedFunction);

/** Color [cssSupportedSpace](https://fakerjs.dev/api/color.html#cssSupportedSpace) */
export const cssSupportedSpace = makeValueConfigFn(faker.color.cssSupportedSpace);
