...
export const airline = makeValueConfigFn(faker.airline.airline) as () => ValueConfig<Airline>;

type Airplane = ReturnType<typeof faker.airline.airplane>;
/** Airline [airplane](https://fakerjs.dev/api/airline.html#airplane) */
export const airplane = makeValueConfigFn(faker.airline.airplane) as () => ValueConfig<Airplane>;

type Airport = ReturnType<typeof faker.airline.airport>;
/** Airline [airport](https://fakerjs.dev/api/airline.html#airport) */
export const airport = makeValueConfigFn(faker.airline.airport) as () => ValueConfig<Airport>;
